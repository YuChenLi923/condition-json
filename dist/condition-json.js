      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            newJson = Array.isArray(json) ? [] : {};
            _context3.next = 4;
            return Promise.all(keys.map(function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(key) {
                var value, parseRes, _result, result, childJSON;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        parseRes = parseExpressionWithKey(key);
                        _result = (0, _expressionParser2.default)(parseRes.expression, scope);
                      ...
                      case 13:
                        ...
                        result = (0, _expressionParser2.default)(key, scope); // value, {}, []
                      ...
                      case 19:
                        ...
                        (0, _extendAssign2.default)(newJson, childJSON, true);
          ...
          case 4:
            return _context3.abrupt('return', newJson);
...
var _extendAssign = __webpack_require__(14);
